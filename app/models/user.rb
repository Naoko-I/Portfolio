class User < ApplicationRecord
  ...
  has_many :followeds, class_name: "Relationship", foreign_key: "followeds_id", dependent: :destroy # フォロワー取得
  has_many :following_user, through: :following, source: :followeds # 自分がフォローしている人
  has_many :followeds_user, through: :followeds, source: :following # 自分をフォローしている人
